...
SELECT 
    german_votes.total_votes AS german_total_votes,
    italian_votes.total_votes AS italian_total_votes,
    CASE 
        WHEN german_votes.total_votes > italian_votes.total_votes THEN 'Yes'
        ELSE 'No'
...
SELECT
    ...
    AVG(avg_rating) AS avg_rating, -- Use an aggregate function for avg_rating
